    ...
    <div class="section">
        <div class="container location-register">
            ...
            <div class="align-items-center d-flex justify-content-center">
                <form class="form-normal" method="post" action="/address/register" id="form-register">
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-7 col-12">
                            <input id="address2" type="text" maxlength="255" class="form-control" name="address2" placeholder="豊島区西池袋" value="{{ old('address2') }}">
                            @error('address2')
                            <p class="input-error"><i class="fas fa-times-circle"></i> {{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row" >
                        ...
                        <div class="col-md-7 col-12">
                            <input type="text" maxlength="255" class="form-control" name="department_name" placeholder="営業部" value="{{ old('company_name') }}">
                    ...
                    <div class="upload-button m-4 create">
                        <button type="button" class="btn custom-btn btn-default" onclick="history.back()">
...
<script>
    ...
    $(document).ready(function() {
        ...
        //     if ($(this).val() == 1) {
        //         window.location.href = '/address/register?selectType=1'
        //     } else if ($(this).val() == 2) {
        //         window.location.href = '/address/register?selectType=2'
        //     }
        // })
