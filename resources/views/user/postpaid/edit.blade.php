    ...
    <div class="section">
        <div class="container location-register">
            ...
            <div class="align-items-center d-flex justify-content-center">
                <form class="form-normal" method="post" action="{{ route('updateAddress', ['address_id' => $address->id]) }}" id="form-register">
                    @csrf
                        ...
                        <div class="col-md-7 col-12">
                            <div class="select-input">
                                <select name="type" class="form-control" id="type">
                                    ...
                                    <option {{ ($address->type == $key ? 'selected' : '') }} value="{{ $key }}">{{ $type }}</option>
                                    @endforeach
                                </select>
                            </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-7 col-12">
                            <input type="text" maxlength="255" class="form-control" name="name" placeholder="音声　太郎" value="{{ $address->full_name }}">
                            @error('name')
                            <p class="input-error"><i class="fas fa-times-circle"></i> {{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-7 col-12">
                            <input type="tel" maxlength="255" class="form-control" name="tel" placeholder="0312345678" value="{{ $address->tel}}">
                            @error('tel')
                            <p class="input-error"><i class="fas fa-times-circle"></i> {{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-7 col-12">
                            <input type="tel" maxlength="255" class="form-control" name="mobile" placeholder="09012345678" value="{{ $address->mobile}}">
                            @error('mobile')
                            <p class="input-error"><i class="fas fa-times-circle"></i> {{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-7 col-12">
                            <input type="text" maxlength="255" class="form-control" name="email" placeholder="voice@voitra.jp" value="{{ $address->email}}">
                            @error('email')
                            <p class="input-error"><i class="fas fa-times-circle"></i> {{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-4 col-12">
                            <input id="zipcode" type="text" maxlength="10" class="form-control" name="zipcode" placeholder="1710021" value="{{ $address->zipcode}}">
                            @error('zipcode')
                            <p class="input-error"><i class="fas fa-times-circle"></i> {{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-7 col-12">
                            <input id="address1" type="text" maxlength="255" class="form-control select-input select" name="address1" placeholder="東京都" value="{{ $address->address1}}">
                            @error('address1')
                            <p class="input-error"><i class="fas fa-times-circle"></i> {{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-7 col-12">
                            <input id="address2" type="text" maxlength="255" class="form-control" name="address2" placeholder="豊島区西池袋" value="{{ $address->address2}}">
                            @error('address2')
                            <p class="input-error"><i class="fas fa-times-circle"></i> {{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-7 col-12">
                            <input id="address3" type="text" maxlength="255" class="form-control" name="address3" placeholder="5-26-19　陸王西池袋ビル6階" value="{{ $address->address3}}">
                            @error('address3')
                            <p class="input-error"><i class="fas fa-times-circle"></i> {{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-7 col-12">
                            <input type="text" maxlength="255" class="form-control" name="company_name" placeholder="アップセルテクノロジィーズ株式会社" value="{{ $address->company_name}}">
                            @error('company_name')
                            <p class="input-error"><i class="fas fa-times-circle"></i> {{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-7 col-12">
                            <input type="text" maxlength="255" class="form-control" name="department_name" placeholder="営業部" value="{{ $address->department_name}}">
                    ...
                    <div class="upload-button m-4 create">
                        <button class="btn custom-btn btn-default" type="button" onclick="history.back()">
                    ...
                    <div class="upload-button m-4 confirm" style="display: none;">
                        <button class="btn custom-btn btn-default edit-data" type="button">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <circle r="11.5" transform="matrix(-1 0 0 1 12 12)" stroke="black" />
                                <path d="M12.2404 6.85693L7.20039 11.9998L12.2404 17.1426M18.4004 11.9998H7.20039H18.4004Z" stroke="black" stroke-width="2" />
                            </svg>
...
<script>
    ...
    $(document).ready(function() {
        ...
        {{--    if ($(this).val() == 1) {--}}
        {{--        window.location.href = '/address/edit/{{ $address->id }}?selectType=1'--}}
        {{--    } else if ($(this).val() == 2) {--}}
        {{--        window.location.href = '/address/edit/{{ $address->id }}?selectType=2'--}}
        {{--    }--}}
        {{--})--}}
