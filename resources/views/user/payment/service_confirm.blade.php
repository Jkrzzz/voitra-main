            ...
            <div class="block-content-sm pt-0 pb-3">
                <div class="box-content">
                    <div class="block-header mb-3 row">
                        <div class="col-md-2">
                            <span class="text-primary">決済カード情報</span>
                        </div>
                        <div class="col-md-2">
                            <a class="text-link" href="{{ isset($order_id) && !is_null($order_id) ? route('changeServicePayCard', ['order_id' => $order_id]) : '/service/change_card/' }}"">
                                カード変更
