...
<div class="main-content">
    ...
    <div class="upload-container">
        <div class="block">
            <div class="block-content">
                <div class="box-header">
                    <span class="title">予約を完了いたしました。</span>
                </div>
                ...
                <div class="text-center">
                    ...
                    <p>
                        テキスト化が完了次第ご登録のメールアドレスに通知致します。
                    </p>
                </div>
                <div class="text-center box-img">
                    <div class="row">
                        <div class="col-md-4 col-12">
                            <img src="{{ asset('user/images/plan2.png') }}" />
                        </div>
                        <div class="col-md-8 col-12 complete-box">
                            <div class="context text-left">
                                <h2>ブラッシュアッププラン</h2>
                                <div class="font-weight-bold mt-3">
                                    <span>AIによるテキスト化をさらにブラッシュアップ！<br>ご希望によりフィラーワードの除去も行います。</span>
                                </div>
                                <div class="mt-4">
                                    <button class="custom-btn-md btn-black {{ $order->status == 6 ? 'brushup' : 'show-notify'}}">
                                        今すぐ発注
                                        <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <circle cx="12.5" cy="12" r="11.5" stroke="white" />
                                            <path d="M12.3619 6.85693L17.3275 11.9998L12.3619 17.1426M6.29297 11.9998H17.3275H6.29297Z" stroke="white" stroke-width="2" />
                                        </svg>
                                    </button>
                                </div>
                            </div>
        ...
        <div class="upload-button">
            <a class="btn custom-btn btn-primary" href="/audio">
                ファイル一覧画面へ進む
