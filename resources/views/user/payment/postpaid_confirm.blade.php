    ...
    <div class="upload-container">
            ...
            <div class="block-content-sm pb-5">
                ...
                <div class="box-content">
                    <div class="block-header mb-3 row confirm-label-des">
                        ...
                        <div class="col-md-2 lang-res header-title text-left">
                            料金（税込）
                        </div>
                    </div>
                    ...
                    <div class="order-item row">
                        ...
                        <div class="col-md-3 order-item-detail">
                        </div>
                        <div class="col-md-2 order-item-detail">
                        </div>
                        <div class="col-md-2 order-item-detail text-left">
                            <span class="page-title text-summary">@money(350)円</span>
                        </div>
                    </div>
                    @if($coupon)
                        <div class="order-item">
                        ...
                        <div class="order-item row">
                            ...
                            <div class="col-md-2 order-item-detail text-left">
                                <span class="page-title text-summary">@money($discountedMoneyTotal + 350)円</span>
                            </div>
                        </div>
                    @else
                        <div class="order-item row">
                            ...
                            <div class="col-md-2 order-item-detail text-left">
                                <span class="page-title text-summary">@money($data->total_price + 350)円</span>
                            </div>
                        </div>
                        @endif
            ...
            <div class="block-content-sm pt-0 pb-3">
                <div class="box-content">
                    <div class="block-header mb-3 d-flex">
                        ...
                        <a href="{{ route('changeAddress', ['type' => 1, 'order_id' => $order_id, 'address_id' => $address->id, 'coupon_id' => @$coupon->id]) }}" class="text-link">
                            変更
                    ...
                    <div class="order-item row">
                        ...
                        <div class="col-md-6 order-item-detail">
                            <span >{{ $user_type[$address->type] }}</span>
                        </div>
                    </div>
                    <div class="order-item row">
                        <div class="col-md-6" style="text-align: left">
                    ...
                    <div class="order-item row">
                        ...
                        <div class="col-md-6 order-item-detail">
                            <span >{{ '〒'.$address->zipcode.$address->address1 . $address->address2 . $address->address3 }}</span>
                        </div>
                    </div>
                    @if($address->type == 1)
                    <div class="order-item row">
                    ...
                    <div class="order-item row">
                        ...
                        <div class="col-md-6 order-item-detail">
                            <span>{{ $address->department_name }}</span>
                        </div>
                    </div>
                    @endif
                </div>
        ...
        <form id="form-order" method="post" action="/upload/complete">
            ...
            <div class="upload-button m-4">
                ...
                <button  class="btn custom-btn btn-primary"  style="width: 300px;">
                    決済してテキスト化を実行
