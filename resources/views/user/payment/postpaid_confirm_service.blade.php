    ...
    <div class="block">
            <div class="block-content-sm pb-5">
                ...
                <div class="box-content">
                    ...
                    <div class="order-item row">
                        <div class="col-md-5">
                            <span class="page-title">話者分離オプション</span>
                        </div>
                        <div class="col-md-3 order-item-detail text-left">
                        </div>
                        <div class="col-md-2 order-item-detail">
                    ...
                    <div class="order-item row">
                        ...
                        <div class="col-md-2 order-item-detail text-left">
                            <span class="page-title text-summary">@money($discountedMoneyTotal + $service->price + 350)円</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="block-content-sm pt-0 pb-3">
                <div class="box-content">
                    <div class="block-header mb-3 d-flex">
                            ...
                            <a href="{{ route('changeAddress', ['type' => 4, 'order_id' => $order_id, 'address_id' => $address->id, 'coupon_id' => @$coupon->id]) }}" class="text-link">
                                変更
