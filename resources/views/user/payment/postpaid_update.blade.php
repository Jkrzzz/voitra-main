...
@section('content')
    <div class="main-content">
        ...
        <div class="notify-warning container"
            style="margin: 10px auto; background: #FFDDE1; padding: 25px 30px; border-radius: 10px">
            <p class="mb-3">
                以下のメッセージ内容を確認し、該当の情報を修正した上で「送信」ボタンを押して与信をかけ直してください。</br>
                修正が必要ない場合も、送信して与信をかけ直してください。</br>
                <b>※入力いただいた内容に間違いがありますと、与信審査が通りませんので正確な情報をご入力ください。</br></b>
            </p>
            <h3>メッセージ：</h3>
            <p class="text-danger">{{ $order->payment_description }}</p>
        </div>
        <div class="notify-warning-confirm container"
            style="margin: 10px auto; background: #FFDDE1; padding: 25px 30px; border-radius: 10px; display: none">
            <p class="mb-3" style="color: #FF0000; font-weight: bold">
                情報が正しいか再度ご確認の上、送信して与信をかけ直しください。<br>
                入力いただいた内容に間違いがありますと、与信審査が通りませんので正確な情報をご入力ください。
            </p>
        </div>
        <div class="section">
            <div class="container location-register">
                <h4 class="sub-title">請求先修正</h4>
                <div class="align-items-center d-flex justify-content-center">
                    <form class="form-normal" method="post" action="/address/register/fix" id="form-register">
                        @csrf
                                ...
                                <div class="select-input">
                                    <select name="type" class="form-control" id="type">
                                        ...
                                        @foreach ($userType as $key => $type)
                                            <option {{ $address->type == $key ? 'selected' : '' }}
                        ...
                        <div class="form-group row">
                            <div class="col-md-5 col-12 cst-label">
                                <label class="col-form-label required">
                                    電話番号
                                    <i class="cust-icon fas fa-info-circle default" data-toggle="tooltip"
                                        data-placement="top" data-html="true" title="半角数字（ハイフン無し）電話番号か携帯番号を入力できます。"></i>
                                </label>
                            </div>
                            <div class="col-md-7 col-12">
                                <input type="tel" maxlength="255" class="form-control" name="tel" placeholder="0312345678"
                                    value="{{ $address->tel }}">
                                @error('tel')
                                    <p class="input-error"><i class="fas fa-times-circle"></i> {{ $message }}</p>
                                @enderror
                        ...
                        <div class="form-group row">
                            <div class="col-md-5 col-12 cst-label">
                                <label class="col-form-label optional">
                                    携帯電話番号
                                    <i class="cust-icon fas fa-info-circle default" data-toggle="tooltip"
                                        data-placement="top" data-html="true" title="半角数字（ハイフン無し）"></i>
                                </label>
                            </div>
                            <div class="col-md-7 col-12">
                                <input type="tel" maxlength="255" class="form-control" name="mobile"
                                    placeholder="09012345678" value="{{ $address->mobile }}">
                                @error('mobile')
                                    <p class="input-error"><i class="fas fa-times-circle"></i> {{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-7 col-12">
                                <input type="text" maxlength="255" class="form-control" name="email"
                                    placeholder="voice@voitra.jp" value="{{ $address->email }}">
                                @error('email')
                                    <p class="input-error"><i class="fas fa-times-circle"></i> {{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-7 col-12">
                                <input id="address1" type="text" maxlength="255" class="form-control select-input select"
                                    name="address1" placeholder="東京都" value="{{ $address->address1 }}">
                                @error('address1')
                                    <p class="input-error"><i class="fas fa-times-circle"></i> {{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-7 col-12">
                                <input id="address2" type="text" maxlength="255" class="form-control" name="address2"
                                    placeholder="豊島区西池袋" value="{{ $address->address2 }}">
                                @error('address2')
                                    <p class="input-error"><i class="fas fa-times-circle"></i> {{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-7 col-12">
                                <input id="address3" type="text" maxlength="255" class="form-control" name="address3"
                                    placeholder="5-26-19　陸王西池袋ビル6階" value="{{ $address->address3 }}">
                                @error('address3')
                                    <p class="input-error"><i class="fas fa-times-circle"></i> {{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-7 col-12">
                                <input type="text" maxlength="255" class="form-control" name="company_name"
                                    placeholder="アップセルテクノロジィーズ株式会社" value="{{ $address->company_name }}">
                                @error('company_name')
                                    <p class="input-error"><i class="fas fa-times-circle"></i> {{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-7 col-12">
                                <input type="text" maxlength="255" class="form-control" name="department_name"
                                    placeholder="営業部" value="{{ $address->department_name }}">
                        ...
                        <div class="upload-button m-4 create">
                            <button class="btn custom-btn btn-default" onclick="history.back()">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    ...
                                    <path
                                        d="M12.2404 6.85693L7.20039 11.9998L12.2404 17.1426M18.4004 11.9998H7.20039H18.4004Z"
                            ...
                            <button id="confirm" class="btn custom-btn btn-primary">
                                ...
                                <svg width="25" height="24" viewBox="0 0 25 24" fill="none"
                                    ...
                                    <path
                                        d="M12.3619 6.85693L17.3275 11.9998L12.3619 17.1426M6.29297 11.9998H17.3275H6.29297Z"
                                        stroke="black" stroke-width="2" />
                                </svg>
                            </button>
                        </div>
    ...
    <input name="is_edit_page" type="hidden" value="1">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            {{-- if ($(this).val() == 1) { --}}
            {{-- window.location.replace('address/fix/{{$service_type}}/{{$order->id}}?selectType=1') --}}

            {{-- } else if ($(this).val() == 2) { --}}
            {{-- window.location.replace('address/fix/{{$service_type}}/{{$order->id}}?selectType=2') --}}
                    ...
                    function(err, addresses) {
                        if (err || addresses.length === 0) {
                            ...
                            if (!$('#zipcode-error').length) {
                                $('#zipcode').after(
                                    '<label id="zipcode-error" class="error" for="zipcode">' + txt +
                                    '</label>');
                            } else {
