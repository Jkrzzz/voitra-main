    ...
    <div class="process-bar">
        <div id="steps">
            ...
            <div class="stepper done">
                <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="20" cy="20" r="18.75" transform="rotate(-180 20 20)" stroke="#B0B0B0" stroke-width="2.5"></circle>
            ...
            <div class="block-content-sm pb-5">
                ...
                <div class="box-content">
                    ...
                    <div class="block-header mb-3 row confirm-label-des">
                        <div class="col-md-3">
                            <span class="page-title bg-primary text-primary">依頼ファイル詳細</span>
                        </div>
                    ...
                    <div class="order-item row">
                        ...
                        <div class="col-md-2 order-item-detail num_speaker">
                            ...
                            <span>{{ $audio->pivot->num_speaker }} 話者分離</span>
                            @else
                    ...
                    <div class="block-header mb-3 row confirm-label-des">
                        <div class="col-md-3">
                            <span class="page-title bg-primary text-primary">オプション</span>
                        </div>
                        <div class="col-md-7 mb-1 lang-res header-title">
                            期間
                        </div>
                        <div class="col-md-2 lang-res header-title">
                            料金（税込）
                    ...
                    <div class="order-item row">
                        <div class="col-md-3">
                            <span class="audio-name">話者分離オプション</span>
                        </div>
                        <div class="col-md-7 mb-1 order-item-detail text-left">
                    ...
                    <div class="order-item row">
                        ...
                        <div class="col-md-2 order-item-detail">
                            <span class="page-title">@money($data->total_price + 300)円</span>
                        </div>
                    </div>
                    <div class="order-item row">
                        <div class="col-md-5">
                        ...
                        <div class="col-md-2 order-item-detail">
                            <span class="page-title">350円</span>
                        </div>
                    </div>
                    <div class="order-item row">
                        <div class="col-md-5">
                        ...
                        <div class="col-md-2 order-item-detail">
                            <span class="page-title text-summary">@money($data->total_price + 300 + 350)円</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="block-content-sm pt-0 pb-3">
                <div class="box-content">
                    <div class="block-header mb-3 d-flex">
                        ...
                        <a href="{{ route('changePayCard', ['order_id' => $order_id]) }}" class="text-link">
                            カード変更
                    ...
                    <div class="order-item row">
                        ...
                        <div class="col-md-6 order-item-detail">
                            <span class="page-title ">{{ $card_number }}</span>
                        </div>
                    </div>
                    <div class="order-item row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6 order-item-detail">
                            <span class="page-title">{{ $card_expire }}</span>
                        </div>
                    </div>
                </div>
            </div>
        </div>
        <form id="form-order" method="post" action="/upload/paywith_service">
            {{ csrf_field() }}
            ...
            <input type="text" id="method" name="method" value="1" hidden>
