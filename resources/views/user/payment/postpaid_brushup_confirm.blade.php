            ...
            <div class="block-content-sm pb-5">
                ...
                <div class="box-content">
                    ...
                    <div class="order-item row">
                        ...
                        <div class="col-md-2 order-item-detail text-right">
                            <span class="">350円</span>
                        </div>
                    </div>
                    <div class="order-item"><hr></div>
                    <div class="order-item row">
                        <div class="col-md-10">
            ...
            <div class="block-content-sm pt-0 pb-3">
                <div class="box-content">
                    <div class="block-header mb-3 d-flex">
                            ...
                            <a href="{{ route('changeAddress', ['type' => 2, 'order_id' => $order_id, 'address_id' => $address->id,'coupon_id' => @$coupon->id]) }}" class="text-link">
                                変更
