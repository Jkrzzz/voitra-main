    ...
    <div class="block">
      <div class="block-content">
        <div class="box-header">
          <span class="title">ブラッシュアップ仮予約が完了しました。</span>
        </div>
        ...
        <div class="text-center">
          <p>
          納品予定日と料金を登録のメールアドレスに送付いたします。<br>
          1営業日以内に連絡がない場合は、お問い合わせください。
          </p>
          <br>
          <p>
          納品予定日の通知から24時間以上経過しますと、納期にも遅れが生じますので、<br>
          お申込みいただくことができなくなります。予めご了承下さい。
          </p>
        </div>
      </div>
    </div>
