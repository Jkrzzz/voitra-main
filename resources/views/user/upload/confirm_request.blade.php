...
<div class="main-content">
  ...
  <div class="upload-container">
      ...
      <div class="block-content">
        ...
        <div class="audio-item">
          <div class="item-header row">
            <div class="col-lg-8 col-md-6 col-12 order">
              <div class="order-header">
                <p class="header-title audio-name font-weight-bold total-order-title" data-toggle="tooltip" data-placement="top" title="{{ $audio['name'] }}">{{ $audio->name }}</p>
              </div>
            </div>
            <div class="col-lg-2 col-md-3 col-12">
              <div class="order-header">
                <p class="header-title font-weight-bold text-right">文字数</p>
              </div>
              <input value="{{ $audio->length . '文字'}}" class="form-control text-right" disabled>
            </div>
            <div class="col-lg-2 col-md-3 col-12">
              <div class="order-header text-right">
                <span class="header-title font-weight-bold ">料金（税込）</span>
              </div>
              <input value="@money($audio->price)円" type='text' class="form-control text-right" disabled />
            </div>
          </div>
        </div>
        @endforeach
        ...
        <div class="audio-item">
          <div class="item-header row">
            <div class="col-lg-4 col-md-12 col-12 order">
              <p class="header-title font-weight-bold total-order-title">ファイル処理料金</p>
            </div>
            <div class="col-lg-2 col-md-3 col-12">
              <div class="order-header">
                <p class="header-title font-weight-bold text-right text-summary">納品希望日</p>
              </div>
              <input value="{{ $order['time_est'] }}" class="form-control text-right" disabled>
            </div>
            <div class="col-lg-2 col-md-3 col-12">
              <div class="order-header">
                <p class="header-title font-weight-bold text-right text-summary">納品予定日</p>
              </div>
              <input value="{{ $order['deadline'] }}" class="form-control text-right" disabled>
            </div>
            <div class="col-lg-2 col-md-3 col-12">
              <div class="order-header text-right">
                <span class="header-title font-weight-bold text-summary">文字</span>
              </div>
              <input value="{{ $order->total_time . '文字'}}" type='text' class="form-control text-right" disabled />
            </div>
            <div class="col-lg-2 col-md-3 col-12">
              <div class="order-header text-right">
                <span class="header-title font-weight-bold text-summary">料金（税込）</span>
              </div>
              <input value="@money($order->total_price)円" class="form-control text-right" disabled>
            </div>
          </div>
        </div>
            @if($isUseCoupon && $coupon)
                <div class="item-header row">
                    ...
                    <div class="col-lg-2 col-md-3 col-12">
                        <input value="-@money($coupon->discount_amount)円" class="form-control text-right" disabled>
                    </div>
                </div>
            @endif
      </div>
    ...
    <form method="post" action="/audio/brushup-confirm" id="form-order">
      {{ csrf_field() }}
      ...
      <div class="form-group my-form-check mb-0">
        ...
        <label class="form-check-label order-page" for="accept">
          <a class="text-link" href="/home/terms.php" target="_blank">利用規約</a> / <a class="text-link" href="/home/privacy.php" target="_blank">プライバシーポリシー</a>
          / 注意事項に同意。
        </label>
      </div>
    </form>
