...
<div class="main-content">
    ...
    <div class="upload-container">
                    ...
                    <div class="item-header row">
                        <div class="col-lg-4 col-md-12 col-12 order">
                            <div class="order-header">
                                <p class="header-title audio-name font-weight-bold" data-toggle="tooltip" data-placement="top" title="{{ $audio['name'] }}">{{ $audio->name }}</p>
                        ...
                        <div class="col-lg-2 col-md-12 col-12">
                            ...
                            <input value="{{ $audio->pivot->num_speaker }}" class="form-control" disabled>
                            @else
                        ...
                        <div class="col-lg-2 col-md-12 col-12">
                            ...
                            <input value="{{ gmdate('H時間i分s秒', $audio->duration) }}" class="form-control" disabled>
                        </div>
                        <div class="col-lg-2 col-md-12 col-12">
                            <div class="order-header">
                                <p class="header-title font-weight-bold">見込処理時間</p>
                            </div>
                            <input value="{{ gmdate("H時間i分s秒", $audio->pivot->estimated_processing_time) }}" class="form-control" disabled>
                        </div>
                        <div class="col-lg-2 col-md-12 col-12">
                            <div class="order-header">
            ...
            <div class="block-content">
                <div class="item-header row">
                    <div class="col-lg-4 col-md-5 col-12">
                        <div class="order-header">
                            <span class="custom-label text-primary bg-primary">オプション</span>
                        </div>
                        <input value="{{$service->name}}" class="form-control" disabled="">
                    </div>
                    <div class="col-lg-1 col-md-1 col-12 table-none"></div>
                    <div class="col-lg-4 col-md-5 col-12">
                        <div class="order-header">
                            <p class="header-title font-weight-bold">期間</p>
                        </div>
                        <input value="{{ $date_from . '~' . $date_to }}" class="form-control" disabled="">
                    </div>
                    <div class="col-lg-1 col-md-1 col-12 table-none"></div>
                    <div class="col-lg-2 col-md-2 col-12">
                        ...
                        <input value="@money($service->price)円" class="form-control" disabled="">
                    </div>
                </div>
                <hr>
                <div class="block-list" style="background-color: #EFEFEF; border-radius: 10px; padding: 15px 10px;margin-top: 26px">
                    <span class="page-title-2">注意事項</span>
                    <ul style="margin-top: 10px;">
        ...
        @endif
        <div class="block" style="background: #FFF9E5;">
            <div class="block-content">
                <div class="audio-item">
                    <div class="item-header row">
                        <div class="col-lg-6 col-md-12">
                            <p class="header-title font-weight-bold" style="font-size: 20px;color: #4B4B4B">ファイル処理料金</p>
                        </div>
                        <div class="col-lg-6 col-md-12 text-right">
                            @money($data->total_price)円
                        </div>
                    </div>
                    @if($isUseCoupon && $coupon)
                    <div class="item-header row">
                        <div class="col-lg-6 col-md-12">
                            <p class="header-title font-weight-bold"
                               style="font-size: 20px;color: #4B4B4B">クーポン割引金額
                                <span class="item-coupon-note" style="display: inline-block">（本体価格からの割引となります。）</span>
                        </div>
                        <div class="col-lg-6 col-md-12 text-right">
                            -@money($coupon->discount_amount)円
                        </div>
                    </div>
                    @endif
                    <div class="item-header row">
                        <div class="col-lg-6 col-md-12">
                            <p class="header-title font-weight-bold" style="font-size: 20px;color: #4B4B4B">話者分離オプション</p>
                        </div>
                        <div class="col-lg-6 col-md-12 text-right">
                            @money($service->price)円
                        </div>
                    </div>
                    <div class="item-header row">
                        <div class="col-lg-6 col-md-12">
                            <p class="header-title font-weight-bold" style="font-size: 20px;color: #4B4B4B">決済手数料</p>
                        </div>
                        <div class="col-lg-6 col-md-12 text-right">
                            350円
                        </div>
                    ...
                    <div class="item-header row">
                        <div class="col-lg-6 col-md-12">
                            <p class="header-title font-weight-bold" style="font-size: 20px;color: #4B4B4B">決済金額</p>
                        </div>
                        <div class="col-lg-6 col-md-12 text-right text-summary font-weight-bold">
                            @if($isUseCoupon && $coupon)
                            @money($discountedMoneyTotal + $service->price + 350 )円
                            @else
                                @money($data->total_price + $service->price + 350 )円
@endif
                        </div>
                    </div>
                </div>
            ...
            <div class="block-content">
                ...
                <div id="postpaid-noty" class="block-list" style="background-color: #FFF; border-radius: 10px; padding: 15px 20px; height: 120px; overflow-y: scroll">
                    <p>• 後払い手数料：350円（税込）</p>
            ...
            <form method="post" action="/upload/payment_service" id="form-order">
                {{ csrf_field() }}
            ...
            <div class="upload-button">
                <a class="btn custom-btn btn-default" href="{{ route('upload.detail', ['order_id' => $data->id]) }}">
                ...
                <button class="btn custom-btn btn-primary" id="payment" disabled>
                    決済画面へ進む
...
<input type="hidden" id="paynow_option" name="paynow_option" value="{{$paynowOption}}">
