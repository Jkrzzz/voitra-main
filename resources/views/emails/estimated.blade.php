...
@section('content')
    <div class="mail-template">
        ...
        @endforeach
        <p>　お客様からご依頼いただいたブラッシュアップの納品予定日が確定いたしました。</p>
        <p>　下記のURLより、納品予定日を確認いただき、ご承諾いただけましたら、決済にお進み下さい。</p>
        <p></p>
        <p>　{{ $app['url']->to('/audio/confirm-request/' . $data['order']) }}</p>
        <p>＜ご注意＞<br>
        納品予定日の通知から24時間以上経過しますと、納品予定日がずれ、<br>
